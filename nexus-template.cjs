...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Refugee Integration Outcomes Nexus";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Refugee Family Case";
process.env.TABLE_NAME = process.env.TABLE_NAME || "refugee_family_case_records";
'use strict';
